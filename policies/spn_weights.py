...
class SPN_Weights(nn.Module):
    ...
    def __init__(self, input_space_dim, action_space_dim):
        ...
        self.hidden_layer = nn.Linear(input_space_dim, HIDDEN_DIM, bias=False)
        self.out_layer = nn.Linear(HIDDEN_DIM, action_space_dim, bias=False)
